-- SwiftJobs Database Schema (FIXED VERSION)
-- This migration creates all tables needed for the matching platform
-- Run the diagnostic script first if you encounter errors
...
-- ============================================================================
-- Drop existing table if needed (UNCOMMENT ONLY IF YOU WANT TO START FRESH)
...
-- ============================================================================
-- IMPORTANT: If jobs table exists with wrong structure, drop it first:
...
CREATE TABLE IF NOT EXISTS public.job_behaviour (
    ...
    work_style TEXT,
    task_structure TEXT,
    environment_pace TEXT,
    decision_making TEXT,
    role_focus TEXT,
    feedback_style TEXT,
    innovation_style TEXT,
    schedule_type TEXT,
    created_at TIMESTAMPTZ DEFAULT NOW(),
    updated_at TIMESTAMPTZ DEFAULT NOW(),
    UNIQUE(job_id)
...
DROP TRIGGER IF EXISTS update_applicant_profiles_updated_at ON public.applicant_profiles;
DROP TRIGGER IF EXISTS update_applicant_preferences_updated_at ON public.applicant_preferences;
DROP TRIGGER IF EXISTS update_applicant_behaviour_updated_at ON public.applicant_behaviour;
DROP TRIGGER IF EXISTS update_jobs_updated_at ON public.jobs;
DROP TRIGGER IF EXISTS update_job_preferences_updated_at ON public.job_preferences;
DROP TRIGGER IF EXISTS update_job_behaviour_updated_at ON public.job_behaviour;
